...
export default function ListItemCard({ title, description, src }: ListBlockItem) {
  return (
    <div className="relative flex flex-col items-center w-40 max-w-[48%] overflow-hidden rounded-xl bg-white bg-clip-border text-gray-700 shadow-md justify-center" >
      ...
      <div className="p-4 sm:p-6 text-center">
        ...
        <p className="block mt-3 font-sans text-base sm:text-xl font-normal leading-relaxed text-gray-700">
          {description}
        </p>
      </div>
    </div>
